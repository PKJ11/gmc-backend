...
const sampleTests = {
  ...
  "Grade7": [
    ...
    // Drag-and-drop
    {
      id: "q5",
      type: "drag-and-drop",
      question: "Arrange these mathematical operations in correct order of operations:",
      items: [
    ...
    // Match-pairs
    {
      ...
      pairs: [
        { id: "pair1", left: "Circle", right: "All points equidistant from center" },
        { id: "pair2", left: "Square", right: "All sides equal, all angles 90°" },
        { id: "pair3", left: "Rectangle", right: "Opposite sides equal, all angles 90°" },
        { id: "pair4", left: "Rhombus", right: "All sides equal, opposite angles equal" }
      ]
    }
  ],
